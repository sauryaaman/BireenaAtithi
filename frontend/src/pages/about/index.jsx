        ...
        <div className="container relative">
          <div className="grid gap-16 lg:grid-cols-2 lg:gap-24">
            ...
            >
              ...
              >
                <span className="text-white">Elevating Hotel Management</span>
            ...
            >
              <div className="relative">
                <div className="aspect-square w-full overflow-hidden rounded-2xl border border-cyan-500/20 bg-slate-900/50 p-8 backdrop-blur-sm">
                  ...
                  <img
                    src="/about/hero.jpg"
                    alt="Hotel Management"
                    className="relative h-full w-full rounded-xl object-cover shadow-2xl"
                  />
                </div>
